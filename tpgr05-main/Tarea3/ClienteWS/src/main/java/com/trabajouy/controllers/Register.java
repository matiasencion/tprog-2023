...
public class Register extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (usrType.equals("empresa")) {
            ...
            try {
                ...
                response.sendRedirect("/web/perfil");  // mover aquí
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
    	 ...
    	 if (nickname != null) {
		     if (portPublicador.existeNickname(nickname)) {
		         out.print("<p style='color: red;'>Nickname en uso</p>"); 
		     } else {
		    	 out.print("<p style='color: green;'>Nickname disponible</p>");
		     }
    	 }
    	 
    	 if (email != null) {
	       if (portPublicador.existeEmail(email)) {
	         out.print("<p style='color: red;'>Email en uso</p>");
	       } else {
	      	 out.print("<p style='color: green;'>Email disponible</p>");
	       }
    	 }
