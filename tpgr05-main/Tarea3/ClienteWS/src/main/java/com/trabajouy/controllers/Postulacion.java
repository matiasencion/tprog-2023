	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(submit != null && submit.equals("Aceptar")) {
	      ...
	      String urlFinal = "";
	        ...
	        urlFinal = "https://www.youtube.com/embed/" + videoId;
    		...
    		try {
				portPublicador.postulacionOfertaLaboral(oferta, nickname, CV, motivacion, fechaFormateada,urlFinal);
			} catch (OfertaNoExisteException_Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			} catch (UsuarioNoExisteException_Exception e) {
