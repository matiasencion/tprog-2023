        ...
        <div class="content-section">
            <div class="card-paquete">
                ...
                <% DtPaquete info = (DtPaquete) request.getAttribute("info_paquete"); %>
                    <img src="/web/media/images/<%= info.getFoto() %>" alt="Imagen de la oferta" />
                    ...
                    <div class="detailed-info">
                        ...
                        <ul>
                      <%
                      DtPaquete.Tofertas tOfertas = info.getTofertas();
                      
                      for (DtPaquete.Tofertas.Entry tipo : tOfertas.getEntry()) {
                      	String nombreTOferta = tipo.getKey();
                      	int cantTOferta = tipo.getValue().getCant();
                    	  %>
                     	  <li><a href="tipo-oferta">
                    	  <%= nombreTOferta %> : <%= cantTOferta %>
                    	  </a>
                    	  </li> 
                      <%}%>
                        </ul>
