...
public class Principal extends JFrame {
    ...
    private VerificarOfertaLaboral VerificarOfertaLaboralIF;
    private OfertasMasVisitadas OfertasMasVisitadasIF;
    ...
    public Principal() throws OfertaNoExisteException {
			Fabrica fabrica = Fabrica.getInstancia();
			ContU = fabrica.getIContUsuario();
			ContO = fabrica.getIContOferta();
			this.CargaDatosIF = new CargaDatos(ContU, ContO);
			/*this.CargaDatosIF.cargarTodo();*/
	...
	private void configurarVentana() {
		...
		private void configurarMenu() {
			...
			JMenu menuTiposPublicacion = new JMenu("Tipos de Publicacion");
			barraMenu.add(menuTiposPublicacion);

			JMenuItem itemAltaTipoPublicacion = new JMenuItem("Alta de Tipo de Publicacion");
			...
			JMenu menuPaquetesPublicacion = new JMenu("Paquetes de Tipo de Publicacion");
			...
			JMenuItem itemVerificarOfertaLaboral = new JMenuItem("Verificar Oferta Laboral");
			itemVerificarOfertaLaboral.addActionListener(e -> VerificarOfertaLaboralIF.setVisible(true));
			barraMenu.add(itemVerificarOfertaLaboral);
			...
			JMenuItem itemOfertasMasVisitadas = new JMenuItem("Ofertas más visitadas");
			itemOfertasMasVisitadas.addActionListener(e-> OfertasMasVisitadasIF.actualizarOfertas(ContO));
			itemOfertasMasVisitadas.addActionListener(e-> OfertasMasVisitadasIF.setVisible(true));
			menuOfertas.add(itemOfertasMasVisitadas);
	...
	private void inicializarVentanasInternas() {
		try {
			...
			inicializarVentana(VerificarOfertaLaboralIF = new VerificarOfertaLaboral(ContO, ContU));
			inicializarVentana(OfertasMasVisitadasIF = new OfertasMasVisitadas(ContO));
